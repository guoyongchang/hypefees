...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'hero.connectWallet': e('or connect wallet','或连接钱包','またはウォレット接続','또는 지갑 연결','o conectar billetera','ou connecter wallet','oder Wallet verbinden','ou conectar carteira','или подключить кошелёк','veya cüzdan bağla'),
