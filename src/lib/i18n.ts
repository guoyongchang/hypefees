...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ── Live Builder Status ──
  'result.liveStatus': e('Current Builder Approval Status', '当前 Builder 授权状态', '現在のビルダー承認状態', '현재 빌더 승인 상태', 'Estado Actual de Aprobación', 'Statut d\'Approbation Actuel', 'Aktueller Genehmigungsstatus', 'Status de Aprovação Atual', 'Текущий Статус Одобрения', 'Güncel Onay Durumu'),
  'result.approved0fee': e('Approved · 0% fee', '已授权 · 0% 费率', '承認済み · 0%手数料', '승인됨 · 0% 수수료', 'Aprobado · 0% comisión', 'Approuvé · 0% frais', 'Genehmigt · 0% Gebühr', 'Aprovado · 0% taxa', 'Одобрено · 0% комиссия', 'Onaylandı · %0 ücret'),
  'result.notApproved': e('Not approved', '未授权', '未承認', '미승인', 'No aprobado', 'Non approuvé', 'Nicht genehmigt', 'Não aprovado', 'Не одобрено', 'Onaylanmadı'),
  'result.previousBuilder': e('(previous)', '(曾用)', '(以前)', '(이전)', '(anterior)', '(précédent)', '(vorherig)', '(anterior)', '(предыдущий)', '(önceki)'),
  'result.onekeyActive': e('You\'re set! OneKey 0% builder fee is active for your address.', '设置完成！OneKey 0% Builder Fee 已对你的地址生效。', '設定完了！OneKey 0%ビルダー手数料があなたのアドレスで有効です。', '설정 완료! OneKey 0% 빌더 수수료가 활성화되었습니다.', '¡Listo! La comisión 0% de OneKey está activa para tu dirección.', 'C\'est fait ! Les frais 0% de OneKey sont actifs pour votre adresse.', 'Fertig! Die 0% Builder-Gebühr von OneKey ist für deine Adresse aktiv.', 'Pronto! A taxa 0% da OneKey está ativa para seu endereço.', 'Готово! Комиссия 0% от OneKey активна для вашего адреса.', 'Tamam! OneKey %0 builder ücreti adresiniz için aktif.'),
  'result.switchHint': e('Switch to 0% builder fee below to save on every future trade.', '在下方切换到 0% Builder Fee，从此每笔交易都省钱。', '下のボタンで0%ビルダー手数料に切り替えて、今後の取引で節約しましょう。', '아래에서 0% 빌더 수수료로 전환하여 향후 모든 거래에서 절약하세요.', 'Cambia a 0% de comisión builder abajo para ahorrar en cada operación futura.', 'Passez à 0% de frais builder ci-dessous pour économiser sur chaque trade.', 'Wechsle unten auf 0% Builder-Gebühr, um bei jedem Trade zu sparen.', 'Mude para 0% de taxa builder abaixo para economizar em cada trade futuro.', 'Переключитесь на 0% комиссию ниже, чтобы экономить на каждой сделке.', 'Her işlemde tasarruf etmek için aşağıdan %0 builder ücretine geçin.'),
