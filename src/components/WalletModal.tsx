...
const WALLETS = [
  ...
  },
  {
    ...
    mobileLink: (url: string) => `metamask://dapp/${url.replace(/^https?:\/\//, '')}`,
  ...
  },
  {
    ...
    mobileLink: (url: string) => `phantom://browse/${encodeURIComponent(url)}`,
  ...
  },
  {
    ...
    mobileLink: (url: string) => `rainbow://wc?uri=${encodeURIComponent(url)}`,
  ...
  },
  {
    ...
    mobileLink: (url: string) => `trust://open_url?coin_id=60&url=${encodeURIComponent(url)}`,
  ...
  },
  {
    ...
    mobileLink: (url: string) => `cbwallet://dapp?url=${encodeURIComponent(url)}`,
